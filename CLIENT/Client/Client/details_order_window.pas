...
begin
    ...
    form_Details_Order.label_dod.Caption := 'Дата поездки: ' + DateTimeToStr(dm.QOrder_By_Id.FieldByName('DATE_OF_DELIVERY').Value);
    ...
    form_Details_Order.label_stevedors.Caption := 'Кол-во пассажиров: ' + IntToStr(dm.QOrder_By_Id.FieldByName('NUMBER_STEVEDORE').Value) + ' человек';
    ...
    form_Details_Order.label_customer_address.Caption := 'Адрес заказчика: г. ' + dm.QAddress_By_Id.FieldByName('CITY').Value + ', ул. ' + dm.QAddress_By_Id.FieldByName('STREET').Value + ', д. ' + IntToStr(dm.QAddress_By_Id.FieldByName('NUMBER_HOUSE').Value) + ', подъезд №' + IntToStr(dm.QAddress_By_Id.FieldByName('FLOOR_').Value);
    dm.QAddress_By_Id.Close;

    dm.QAddress_By_Id.ParamByName('ID_ADDRESS').Value := address_id_from;
    dm.QAddress_By_Id.Open;
    form_Details_Order.label_from_address.Caption := 'Откуда: г. ' + dm.QAddress_By_Id.FieldByName('CITY').Value + ', ул. ' + dm.QAddress_By_Id.FieldByName('STREET').Value + ', д. ' + IntToStr(dm.QAddress_By_Id.FieldByName('NUMBER_HOUSE').Value) + ', подъезд №' + IntToStr(dm.QAddress_By_Id.FieldByName('FLOOR_').Value);
    dm.QAddress_By_Id.Close;

    dm.QAddress_By_Id.ParamByName('ID_ADDRESS').Value := address_id_to;
    dm.QAddress_By_Id.Open;
    form_Details_Order.label_to_address.Caption := 'Куда: г. ' + dm.QAddress_By_Id.FieldByName('CITY').Value + ', ул. ' + dm.QAddress_By_Id.FieldByName('STREET').Value + ', д. ' + IntToStr(dm.QAddress_By_Id.FieldByName('NUMBER_HOUSE').Value) + ', подъезд №' + IntToStr(dm.QAddress_By_Id.FieldByName('FLOOR_').Value);
    dm.QAddress_By_Id.Close;
