...
import com.example.garbagecollector.LoginDialog;
...
public class MainActivity extends AppCompatActivity implements LoginDialog.LoginDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color=\"grey\">" + "Заказы" + "</font>")); // getSupportActionBar().setTitle("Ордеры");
