...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        nameTextView.setText("\uD83D\uDC64 Клиент:  " + receivedOrder.getCustomerName());
        ...
        numberOfMoversTextView.setText("‍️\uD83E\uDD84 ️Пассажиров:  " + String.valueOf(receivedOrder.getNumberOfMovers()));
        phoneNumberTextView.setText("\uD83D\uDCF1 Номер телефона клиента:  " + receivedOrder.getPhoneNumber());
